...
const MainContent: React.FC = () => {
  ...
  const slides = [
    {
      ...
      description:
        t.dark_mode_desc ||
        "Thư giãn và bảo vệ mắt với chế độ tối mới trên Sophy PC",
    ...
    },
    {
      ...
      description:
        t.quick_msg_desc || "Lưu sẵn các tin nhắn thường dùng để gửi nhanh",
    },
    {
      imgSrc: seamlessImg,
      ...
      description:
        t.seamless_desc ||
        "Kết nối và làm việc trên mọi thiết bị với dữ liệu đồng bộ",
    },
    {
  ...
  return (
    <div className="flex-1 w-full flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="text-center mb-4">
        <h1 className="text-2xl text-gray-900 dark:text-gray-100">
          {t.welcome || "Chào mừng đến với"}{" "}
          <span className="font-bold">Sophy PC!</span>
        </h1>
      ...
      <div className="relative flex items-center justify-center w-full max-w-lg">
        <button
          type="button"
          className="absolute left-0 p-2 rounded-full cursor-pointer text-blue-500 dark:text-blue-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition"
          onClick={handlePrev}
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {slides[currentSlide].buttonText && (
            <button
              type="button"
              className="mt-4 bg-blue-500 dark:bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-600 dark:hover:bg-blue-700 transition">
              {slides[currentSlide].buttonText}
            </button>
          )}
        </div>
        <button
          type="button"
          className="absolute right-0 p-2 rounded-full text-blue-500 dark:text-blue-300 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition"
          onClick={handleNext}
          title="Next Slide">
          <RightOutlined />
        </button>
